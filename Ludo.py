                ...
                if path_counter == 0:
                    ...
                    if  counter_coin == 106:
                        ...
                        if self.robo_prem == 1 and color_coin == "red":
                            messagebox.showinfo("Destination reached","Hey! I am at my destination!")
                        else:
                            messagebox.showinfo("Destination reached","Congrats! You are at your destination!")
                        if path_counter == 6:
        ...
        if  destination_reached == 1:# If all coins in block reach to the destination, winner and runner check
            ...
            if self.take_permission == 1:# Winner check
                if self.robo_prem == 1 and color_coin == "red":
                    ...
                    messagebox.showinfo("Winner","Congrats! You win!")
...
if __name__ == '__main__':
    ...
    window.iconbitmap("Ludo Game Board.png")
